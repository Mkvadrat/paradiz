...
?>
	...
	<div class="main-reviews">
		...
		?>
		<div class="header-banner-block header-shares" data-speed="2" data-type="background" style="background-image: url( '<?php echo $image_background[0] ? $image_background[0] : esc_url( get_template_directory_uri() ) . '/wp-content/themes/paradiz//wp-content/themes/paradiz/images/bg-first-block.png'; ?>'>
			<div class="container">
				<div class="row">
					<div class="col-md-12">
