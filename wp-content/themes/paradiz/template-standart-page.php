...
?>
	...
	<div class="main-galery">
		...
		?>
		<div class="header-banner-block header-shares" data-speed="2" data-type="background" style="background-image: url( '<?php echo $image_background[0] ? $image_background[0] : esc_url( get_template_directory_uri() ) . '/images/bg-shares-list.jpg'; ?>' );" );">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
